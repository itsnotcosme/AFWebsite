    ...
    <section id="about" ref={ref}>
      <div className="container">
        ...
        <div style={{ maxWidth: "800px" }}>
          ...
          <p className="reveal reveal-up delay-2" style={{ marginBottom: "1.5rem", marginTop: "1rem", color: "var(--white)" }}>
          ...
          <p className="reveal reveal-up delay-3" style={{ marginBottom: "1.5rem", color: "var(--white)" }}>
          ...
          <p className="reveal reveal-up delay-4" style={{ marginBottom: "1.5rem", color: "var(--white)" }}>
          ...
          <p className="reveal reveal-up delay-5" style={{ color: "var(--white)" }}>
