...
export default function About() {
  ...
  return (
    <section id="about" ref={ref} style={{ background: "var(--white)" }}>
      <div className="container">
        ...
        <h2
          ...
          style={{ marginBottom: "2rem", textTransform: "uppercase", color: "var(--navy)" }}
        >
          Alberto Ferreira
        </h2>
        ...
        <div style={{ maxWidth: "800px" }}>
          ...
          <p className="reveal reveal-up delay-2" style={{ marginBottom: "1.5rem", marginTop: "1rem", color: "var(--navy)" }}>
          ...
          <p className="reveal reveal-up delay-3" style={{ marginBottom: "1.5rem", color: "var(--navy)" }}>
          ...
          <p className="reveal reveal-up delay-4" style={{ marginBottom: "1.5rem", color: "var(--navy)" }}>
          ...
          <p className="reveal reveal-up delay-5" style={{ color: "var(--navy)" }}>
